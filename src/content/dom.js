;(function() {
    ...
    require.register('component-event/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-delegate/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-domify/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-indexof/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-classes/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('visionmedia-debug/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('visionmedia-debug/debug.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('ianstormtaylor-to-no-case/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('ianstormtaylor-to-space-case/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('ianstormtaylor-to-camel-case/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-within-document/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-css/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-css/lib/css.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-css/lib/prop.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-css/lib/swap.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-css/lib/style.js', function(
        exports,
        require,
        module
    ) {
        ...
        function style(el, prop, val, extra) {
            ...
            if (
                !hook ||
                !hook.set ||
                undefined !== (val = hook.set(el, val, extra))
            ) {
                // Support: Chrome, Safari
                // Setting style to blank string required to delete "style: x !important;"
                debug(
                    'set hook defined. setting property (%s) to %s',
                    prop,
                    val
                )
                style[prop] = ''
        ...
        function get(el, prop, orig, extra) {
            ...
            if (
                hook &&
                hook.get &&
                undefined !== (ret = hook.get(el, false, extra))
            ) {
    ...
    require.register('component-css/lib/hooks.js', function(
        exports,
        require,
        module
    ) {
        ...
        ;['width', 'height'].forEach(function(name) {
            ...
            exports[name].get = function(el, compute, extra) {
                ...
                return 0 == el.offsetWidth &&
                    rdisplayswap.test(css(el, 'display'))
        ...
        function getWidthOrHeight(el, prop, extra) {
            ...
            var isBorderBox =
                support.boxSizing && css(el, 'boxSizing') === 'border-box'
            ...
            if (val <= 0 || val == null) {
                ...
                valueIsBorderBox =
                    isBorderBox &&
                    (support.boxSizingReliable() || val === el.style[prop])
    ...
    require.register('component-css/lib/styles.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-css/lib/vendor.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-css/lib/support.js', function(
        exports,
        require,
        module
    ) {
        ...
        exports.boxSizingReliable = function() {
            if (undefined == boxSizingReliableVal)
                computePixelPositionAndBoxSizingReliable()
    ...
    require.register('component-css/lib/computed.js', function(
        exports,
        require,
        module
    ) {
        ...
        function computed(el, prop, precomputed) {
            ...
            if ('' === ret && !withinDocument(el)) {
                debug(
                    'element not within document, try finding from style attribute'
                )
    ...
    require.register('component-type/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-value/index.js', function(
        exports,
        require,
        module
    ) {
        ...
        function type(el) {
            ...
            if (group && type && 'radio' == type.toLowerCase())
                return 'radiogroup'
            if ('input' == name && type && 'checkbox' == type.toLowerCase())
                return 'checkbox'
            if ('input' == name && type && 'radio' == type.toLowerCase())
                return 'radio'
            if ('select' == name) return 'select'
            return name
        }
    })
    require.register('component-query/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-matches-selector/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('yields-traverse/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-trim/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('yields-isArray/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-props/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('component-to-function/index.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('dom/lib/traverse.js', function(exports, require, module) {
        ...
        exports.parent = function(selector, limit) {
            return this.dom(
                traverse('parentNode', this[0], selector, limit || 1)
            )
        }
        ...
        exports.next = function(selector, limit) {
            return this.dom(
                traverse('nextSibling', this[0], selector, limit || 1)
            )
        }
        ...
        exports.prev = exports.previous = function(selector, limit) {
            return this.dom(
                traverse('previousSibling', this[0], selector, limit || 1)
            )
        }
        ...
        exports.filter = exports.select = function(fn) {
            fn = toFunction(fn)
            var dom = this.dom
            var out = []
            var val
    ...
    require.register('dom/lib/manipulate.js', function(
        exports,
        require,
        module
    ) {
    ...
    require.register('dom/lib/attributes.js', function(
        exports,
        require,
        module
    ) {
        ...
        exports.val = exports.value = function(val) {
    ...
    require.alias(
        ...
        'component-delegate/deps/matches-selector/index.js'
    )
    require.alias(
        'component-query/index.js',
        'component-matches-selector/deps/query/index.js'
    )
    ...
    require.alias(
        'component-css/lib/computed.js',
        'dom/deps/css/lib/computed.js'
    )
    require.alias('component-css/index.js', 'dom/deps/css/index.js')
    require.alias('component-css/index.js', 'css/index.js')
    require.alias(
        'visionmedia-debug/index.js',
        'component-css/deps/debug/index.js'
    )
    require.alias(
        'visionmedia-debug/debug.js',
        'component-css/deps/debug/debug.js'
    )

    require.alias(
        'ianstormtaylor-to-camel-case/index.js',
        'component-css/deps/to-camel-case/index.js'
    )
    require.alias(
        'ianstormtaylor-to-space-case/index.js',
        'ianstormtaylor-to-camel-case/deps/to-space-case/index.js'
    )
    require.alias(
        'ianstormtaylor-to-no-case/index.js',
        'ianstormtaylor-to-space-case/deps/to-no-case/index.js'
    )

    require.alias(
        'component-within-document/index.js',
        'component-css/deps/within-document/index.js'
    )
    ...
    require.alias(
        ...
        'component-value/deps/type/index.js'
    )
    ...
    require.alias(
        'component-matches-selector/index.js',
        'dom/deps/matches-selector/index.js'
    )
    require.alias(
        'component-matches-selector/index.js',
    ...
    require.alias(
        'component-matches-selector/index.js',
        'yields-traverse/deps/matches-selector/index.js'
    )
    require.alias(
        'component-query/index.js',
        'component-matches-selector/deps/query/index.js'
    ...
    require.alias(
        'component-to-function/index.js',
        'dom/deps/to-function/index.js'
    )
    require.alias('component-to-function/index.js', 'to-function/index.js')
    require.alias(
        'component-props/index.js',
        'component-to-function/deps/props/index.js'
    )
    require.alias(
        'component-props/index.js',
        'component-to-function/deps/props/index.js'
